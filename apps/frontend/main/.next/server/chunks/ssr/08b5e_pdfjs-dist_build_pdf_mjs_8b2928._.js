module.exports = {
  '[project]/node_modules/pdfjs-dist/build/pdf.mjs [app-ssr] (ecmascript)': (
    ...
    } = __turbopack_context__;
    {
      ...
      const __TURBOPACK__import$2e$meta__ = {
        get url() {
          return `file://${__turbopack_resolve_absolute_path__('node_modules/pdfjs-dist/build/pdf.mjs')}`;
        },
      };
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        AnnotationEditorParamsType: () =>
          /* reexport */ AnnotationEditorParamsType,
        AnnotationEditorType: () => /* reexport */ AnnotationEditorType,
        AnnotationEditorUIManager: () =>
          /* reexport */ AnnotationEditorUIManager,
        ...
        RenderingCancelledException: () =>
          /* reexport */ RenderingCancelledException,
        TextLayer: () => /* reexport */ TextLayer,
        TouchManager: () => /* reexport */ TouchManager,
        UnexpectedResponseException: () =>
          /* reexport */ UnexpectedResponseException,
        Util: () => /* reexport */ Util,
      ...
      class AnnotationEditor {
        ...
        #touchPinchCallback(_origin, prevDistance, distance) {
          ...
          const centerX = AnnotationEditor._round(
            savedX + transfCenterPoint[0]
          );
          const centerY = AnnotationEditor._round(
            savedY + transfCenterPoint[1]
          );
          ...
          if (nextFirstPosition !== firstPosition) {
            if (nextFirstPosition < firstPosition) {
              ...
              for (let i = 0; i < nextFirstPosition - firstPosition; i++) {
                this.#resizersDiv.firstChild.before(
                  this.#resizersDiv.lastChild
                );
              }
            }
            let i = 0;
        ...
        renderAnnotationElement(annotation) {
          let content =
            annotation.container.querySelector('.annotationContent');
          if (!content) {
      ...
      class DOMFilterFactory extends BaseFilterFactory {
        ...
        addFilter(maps) {
          ...
          const key =
            maps.length === 1 ? tableR : `${tableR}${tableG}${tableB}`;
      ...
      class NodeCanvasFactory extends BaseCanvasFactory {
        _createCanvas(width, height) {
          const require = process
            ...
            .createRequire(__TURBOPACK__import$2e$meta__.url);
      ...
      class MeshShadingPattern extends BaseShadingPattern {
        ...
        getPattern(ctx, owner, inverse, pathType) {
          ...
          if (pathType === PathType.SHADING) {
            ...
            if (this.matrix) {
              const matrixScale = Util.singularValueDecompose2dScale(
                this.matrix
              );
      ...
      class CanvasExtraState {
        ...
        updateCurvePathMinMax(
          ...
          const box = Util.bezierBoundingBox(
            x0,
            y0,
            x1,
            y1,
      ...
      function putBinaryImageData(ctx, imgData) {
        ...
        if (imgData.kind === util_ImageKind.GRAYSCALE_1BPP) {
          ...
          const black = util_FeatureTest.isLittleEndian
            ? 0xff000000
            : 0x000000ff;
      ...
      class CanvasGraphics {
        ...
        setFillRGBColor(r, g, b) {
          this.ctx.fillStyle = this.current.fillColor = Util.makeHexColor(
            r,
            g,
            b
          );
      ...
      const DefaultCanvasFactory = isNodeJS
        ? NodeCanvasFactory
        : DOMCanvasFactory;
      const DefaultCMapReaderFactory = isNodeJS
        ? NodeCMapReaderFactory
        : DOMCMapReaderFactory;
      const DefaultFilterFactory = isNodeJS
        ? NodeFilterFactory
        : DOMFilterFactory;
      ...
      class WorkerTransport {
        ...
        setupMessageHandler() {
          ...
          messageHandler.on('commonobj', ([id, type, exportedData]) => {
            ...
            switch (type) {
              case 'Font':
                const { disableFontFace, fontExtraProperties, pdfBug } =
                  this._params;
        ...
        cachedPageNumber(ref) {
          ...
          const refStr =
            ref.gen === 0 ? `${ref.num}R` : `${ref.num}R${ref.gen}`;
      ...
      class WidgetAnnotationElement extends AnnotationElement {
        ...
        _getKeyModifier(event) {
          return util_FeatureTest.platform.isMac
            ? event.metaKey
            : event.ctrlKey;
        }
        _setEventListener(
      ...
      class AnnotationLayer {
        ...
        async render(params) {
          ...
          const elementParams = {
            ...
            annotationStorage:
              params.annotationStorage || new AnnotationStorage(),
      ...
      class FreeTextEditor extends AnnotationEditor {
        ...
        editorDivPaste(event) {
          ...
          let beforeLength = bufferBefore.reduce(
      ...
      class InkDrawOutliner {
        ...
        toSVGPath() {
          ...
          for (
            let i = this.#lastIndex, ii = this.#line.length;
            i < ii;
            i += 6
          ) {
      ...
      class InkDrawOutline extends Outline {
        ...
        #getMarginComponents(thickness = this.#thickness) {
          const margin =
            this.#innerMargin + (thickness / 2) * this.#parentScale;
      ...
      class StampEditor extends AnnotationEditor {
        ...
        #drawBitmap() {
          ...
          const scaledHeight = Math.ceil(
            height * parentHeight * outputScale.sy
          );
      ...
      class DrawLayer {
        ...
        draw(properties, isPathUpdatable = false, hasClip = false) {
          ...
          const clipPathId = hasClip
            ? this.#createClipPath(defs, pathId)
            : null;
...
//# sourceMappingURL=08b5e_pdfjs-dist_build_pdf_mjs_8b2928._.js.map
